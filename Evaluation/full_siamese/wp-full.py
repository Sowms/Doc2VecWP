...
def create_pairs(x, digit_indices, output):
...
tr_pairs, tr_y = create_pairs(x_train, digit_indices, schemas)

digit_indices = [np.where(y_test == i)[0] for i in range(num_classes)]
te_pairs, te_y = create_pairs(x_test, digit_indices, schemas)
